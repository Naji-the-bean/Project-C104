...
cv2.putText(img,"Venus",(185,200), cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255))
...
cv2.putText(img,"Jupiter",(480,200), cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,0))
cv2.putText(img,"Saturn",(750,200), cv2.FONT_HERSHEY_COMPLEX,0.5,(255,255,255))
cv2.putText(img,"Uranus",(960,200), cv2.FONT_HERSHEY_COMPLEX,0.5,(0,0,0))
